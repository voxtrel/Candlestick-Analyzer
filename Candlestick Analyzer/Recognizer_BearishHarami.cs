...
{
    /// <summary>
    /// This is the recognizer class for the Bearish Harami pattern, which uses the recognizer abstract class as a template
    /// </summary>
    internal class Recognizer_BearishHarami : Recognizer
    {
        ...
        public override bool Recognize(List<SmartCandlestick> lscs, int currIndex)
        {
            ...
            else
            {
                ...
                currC.CandleProperties.Add(patternName, isPrevBullish && isCurrBearish && isCurrBodyContained); // Add the result to the dictionary
                ...
                return isPrevBullish && isCurrBearish && isCurrBodyContained;
            }
