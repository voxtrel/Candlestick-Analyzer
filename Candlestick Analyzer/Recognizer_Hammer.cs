...
{
    /// <summary>
    /// This is the recognizer class for the Hammer pattern, which uses the recognizer abstract class as a template
    /// </summary>
    internal class Recognizer_Hammer : Recognizer
    {
        ...
        public override bool Recognize(List<SmartCandlestick> lscs, int currIndex)
        {
            ...
            {
                bool cv = (cs.BodyRange <= (decimal)0.25 * cs.Range                   // BodyRange maximum of 25% of Range
                          && cs.BodyRange > (decimal)0.15 * cs.Range                  // BodyRange mininum of 15% of Range
                          && (cs.TopTail >= (decimal)0.75 * cs.Range                  // TopTail small and BottomTail long
                          || cs.BottomTail >= (decimal)0.75 * cs.Range));             // Or BottomTail small and TopTail long
